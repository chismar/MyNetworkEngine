...
//Last modified: Mon, Feb 03, 2020 02:46:49 AM
//Codeset: 1251
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -256.53278078240749 337.14488272030826 296.54153473025752 ;
	setAttr ".r" -type "double3" -34.538352729592269 -40.200000000005247 -4.1641414228734673e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "FA1567D2-4295-48B6-5C88-328B55B081EB";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 602.80673913404178;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode transform -n "IMPORT_SLOTS";
	rename -uid "3552BFE7-4410-466F-33B4-15B62064C109";
createNode joint -n "Slot_Hand_L" -p "IMPORT_SLOTS";
...
createNode scaleConstraint -n "Slot_Hand_L1_scaleConstraint1" -p "Slot_Hand_L";
	...
	setAttr ".erp" yes;
	setAttr -k on ".w0";
createNode joint -n "Slot_World" -p "IMPORT_SLOTS";
...
createNode scaleConstraint -n "Slot_Hand_L_scaleConstraint1" -p "Slot_World";
	...
	setAttr ".erp" yes;
	setAttr -k on ".w0";
createNode transform -n "Item_World_control_group" -p "IMPORT_SLOTS";
...
createNode nurbsCurve -n "Item_World_controlShape" -p "Item_World_control";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		;
createNode joint -n "Weapon_L" -p "IMPORT_SLOTS";
...
createNode parentConstraint -n "Weapon_L_parentConstraint1" -p "Weapon_L";
	...
	setAttr -k on ".w0";
createNode transform -n "Weapon_R_control_group" -p "IMPORT_SLOTS";
...
createNode nurbsCurve -n "Weapon_R_controlShape" -p "Weapon_R_control";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		;
createNode transform -n "Weapon_L_control_group" -p "IMPORT_SLOTS";
...
createNode nurbsCurve -n "Weapon_L_controlShape" -p "Weapon_L_control";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		;
createNode transform -n "Item_R_control_group" -p "IMPORT_SLOTS";
...
createNode transform -n "Item_L_control_group" -p "IMPORT_SLOTS";
...
createNode nurbsCurve -n "Item_L_controlShape" -p "Item_L_control";
	...
	setAttr -s 9 ".cp[0:8]" -type "double3" -1.8060796258486976e-13 3.5825209630386172e-16 
		...
		-11.509270686653736;
createNode joint -n "Slot_Hand_R" -p "IMPORT_SLOTS";
...
createNode parentConstraint -n "Slot_Hand_R_parentConstraint1" -p "Slot_Hand_R";
	...
	setAttr -k on ".w0";
createNode joint -n "Weapon_R" -p "IMPORT_SLOTS";
	...
	setAttr ".bps" -type "matrix" 1 0 0 0 0 1 0 0 0 -2.4651903288156619e-32 1.0000000000000002 0
		 -2.8421709430404007e-14 2.8421709430404007e-14 -4.4408920985006262e-16 1;
createNode joint -n "Weapon_R_end" -p "Weapon_R";
...
createNode displayLayerManager -n "layerManager";
	rename -uid "6D91570C-43C1-E11B-B877-2FB892883078";
	setAttr ".cdl" 15;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "7AD292DB-4573-1D52-A374-4482B734CB39";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "5E514FB9-4DD3-9EC3-F55E-E6AC5251DE2A";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "9E610E94-43F5-CF8E-7A9B-5BB1EA36624C";
createNode displayLayer -n "defaultLayer";
	rename -uid "1AC95948-4E59-E8EF-3BAD-5A8581EE82EA";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "2E690BCF-4AF6-F8B3-0515-8DAA77403280";
...
connectAttr "Weapon_L.s" "Weapon_L_end.is";
...
connectAttr "Weapon_R.s" "Weapon_R_end.is";
