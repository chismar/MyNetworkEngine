...
namespace MessagePack.Resolvers
{
    ...
    public sealed class DynamicUnionResolver : IFormatterResolver
    {
        ...
        {
            _reverseUnionTypes = AppDomain.CurrentDomain.GetAssemblies().SelectMany(x => x.GetTypes()).Where(x => x.GetCustomAttribute<ReverseUnionAttribute>() != null).ToDictionary(x => x, y => y.GetCustomAttribute<ReverseUnionAttribute>());
