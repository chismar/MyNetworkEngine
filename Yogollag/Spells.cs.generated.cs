...
namespace Yogollag
{
    ...
    public partial class SpellsEngineSync : SpellsEngine, IGhost
    {
        ...
        {
            CheckStream(stream, -396193698);
            //var hasAny = stream.GetBool();
            //if(!hasAny)
            //    return;
            var mask = stream.GetInt();
            CheckStream(stream, 279832081);
            if ((mask & (1 << 0)) != 0)
            {
                CheckStream(stream, 279832081);
        ...
        public bool Serialize(ref NetDataWriter stream, bool initial)
        {
            if (stream == null)
                stream = new NetDataWriter(true, 5);
            SafeguardStream(stream, -396193698);
            bool hasAny = false;
            ...
            SafeguardStream(stream, 279832081);
            if ((deltaMask & (1 << 0)) != 0)
            {
                SafeguardStream(stream, 279832081);
                hasAny = true;
            ...
            SafeguardStream(stream, 1339203984);
            if ((deltaMask & (1 << 1)) != 0)
            {
                SafeguardStream(stream, 1339203984);
                hasAny = true;
            ...
            SafeguardStream(stream, -1129810394);
            if ((deltaMask & (1 << 2)) != 0)
            {
                SafeguardStream(stream, -1129810394);
                hasAny = true;
    ...
    {
        public override int NetId => -1415083999;
    ...
    {
        public override int NetId => -853776690;
        public SpellId id;
        public SpellCast cast;
        public override void Run(object entity)
        {
    ...
    {
        public override int NetId => 1966508688;
        public SpellId id;
        public override void Run(object entity)
        {
    ...
    {
        public override int NetId => -1012841239;
        public SpellId id;
        public override void Run(object entity)
        {
...
namespace Yogollag
{
    ...
    public partial class SpellInstanceSync : SpellInstance, IGhost
    {
        ...
        public void Deserialize(NetDataReader stream)
        {
            CheckStream(stream, -1718194698);
            //var hasAny = stream.GetBool();
            //if(!hasAny)
            //    return;
            var mask = stream.GetInt();
            CheckStream(stream, 696114188);
            if ((mask & (1 << 0)) != 0)
            {
                CheckStream(stream, 696114188);
        ...
        public bool Serialize(ref NetDataWriter stream, bool initial)
        {
            if (stream == null)
                stream = new NetDataWriter(true, 5);
            SafeguardStream(stream, -1718194698);
            bool hasAny = false;
            int deltaMask = _deltaMask;
            if (initial)
                deltaMask = int.MaxValue;
            ...
            //stream.Put(true);
            stream.Put(deltaMask);
            SafeguardStream(stream, 696114188);
            if ((deltaMask & (1 << 0)) != 0)
            {
                SafeguardStream(stream, 696114188);
                hasAny = true;
            ...
            SafeguardStream(stream, 1364172968);
            if ((deltaMask & (1 << 1)) != 0)
            {
                SafeguardStream(stream, 1364172968);
                hasAny = true;
            ...
            SafeguardStream(stream, -257296600);
            if ((deltaMask & (1 << 2)) != 0)
            {
                SafeguardStream(stream, -257296600);
                hasAny = true;
            ...
            SafeguardStream(stream, 1335067399);
            if ((deltaMask & (1 << 3)) != 0)
            {
                SafeguardStream(stream, 1335067399);
                hasAny = true;
