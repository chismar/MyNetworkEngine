...
namespace Yogollag
{
    ...
    public partial class SpellsEngineSync : SpellsEngine, IGhost
    {
        ...
        public bool Serialize(ref NetDataWriter stream, bool initial)
        {
            ...
            SafeguardStream(stream, 115058042);
            if ((deltaMask & (1 << 0)) != 0)
            {
                SafeguardStream(stream, 115058042);
                hasAny = true;
            ...
            SafeguardStream(stream, -1609159795);
            if ((deltaMask & (1 << 1)) != 0)
            {
                SafeguardStream(stream, -1609159795);
                hasAny = true;
            ...
            SafeguardStream(stream, 2052591507);
            if ((deltaMask & (1 << 2)) != 0)
            {
                SafeguardStream(stream, 2052591507);
                hasAny = true;
    ...
    {
        public override int NetId => -762522614;
    ...
    {
        public override int NetId => 1084348721;
        public SpellId id;
        public SpellCast cast;
        public override void Run(object entity)
        {
    ...
    {
        public override int NetId => -1269328360;
        public SpellId id;
        public override void Run(object entity)
        {
    ...
    {
        public override int NetId => -1481785515;
        public SpellId id;
        public override void Run(object entity)
        {
...
namespace Yogollag
{
    ...
    public partial class SpellInstanceSync : SpellInstance, IGhost
    {
        ...
        public void Deserialize(NetDataReader stream)
        {
            CheckStream(stream, 1971480904);
            //var hasAny = stream.GetBool();
            //if(!hasAny)
            //    return;
            var mask = stream.GetInt();
            CheckStream(stream, 332329845);
            if ((mask & (1 << 0)) != 0)
            {
                CheckStream(stream, 332329845);
        ...
        public bool Serialize(ref NetDataWriter stream, bool initial)
        {
            if (stream == null)
                stream = new NetDataWriter(true, 5);
            SafeguardStream(stream, 1971480904);
            bool hasAny = false;
            int deltaMask = _deltaMask;
            if (initial)
                deltaMask = int.MaxValue;
            ...
            //stream.Put(true);
            stream.Put(deltaMask);
            SafeguardStream(stream, 332329845);
            if ((deltaMask & (1 << 0)) != 0)
            {
                SafeguardStream(stream, 332329845);
                hasAny = true;
            ...
            SafeguardStream(stream, -618075406);
            if ((deltaMask & (1 << 1)) != 0)
            {
                SafeguardStream(stream, -618075406);
                hasAny = true;
            ...
            SafeguardStream(stream, -443459552);
            if ((deltaMask & (1 << 2)) != 0)
            {
                SafeguardStream(stream, -443459552);
                hasAny = true;
            ...
            SafeguardStream(stream, 1025414018);
            if ((deltaMask & (1 << 3)) != 0)
            {
                SafeguardStream(stream, 1025414018);
                hasAny = true;
