...
namespace Yogollag
{
    ...
    public class SimpleSpawnerSync : SimpleSpawner, IGhost
    {
        ...
        public bool Serialize(ref NetDataWriter stream, bool initial)
        {
            ...
            SafeguardStream(stream, -1771324387);
            bool hasAny = false;
            ...
            SafeguardStream(stream, -383938375);
            if ((deltaMask & (1 << 2)) != 0)
            {
                SafeguardStream(stream, -383938375);
                hasAny = true;
