...
namespace Yogollag
{
    ...
    public class ChunkEntitySync : ChunkEntity, IGhost
    {
        ...
        {
            CheckStream(stream, 296673256);
            //var hasAny = stream.GetBool();
            //if(!hasAny)
            //    return;
            var mask = stream.GetInt();
            CheckStream(stream, -382253197);
            if ((mask & (1 << 0)) != 0)
            {
                CheckStream(stream, -382253197);
        ...
        public bool Serialize(ref NetDataWriter stream, bool initial)
        {
            ...
            SafeguardStream(stream, 296673256);
            bool hasAny = false;
            ...
            SafeguardStream(stream, -382253197);
            if ((deltaMask & (1 << 0)) != 0)
            {
                SafeguardStream(stream, -382253197);
                hasAny = true;
    ...
    {
        public override int NetId => 2081856664;
        public int x;
        public int y;
    ...
    {
        public override int NetId => 467732470;
        public int x;
        public int y;
        public TileModDef modDef;
        public override void Run(object entity)
