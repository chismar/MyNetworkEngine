...
namespace Yogollag
{
    ...
    public partial class MobSync : Mob, IGhost
    {
        ...
        {
            CheckStream(stream, 24112477);
            //var hasAny = stream.GetBool();
            //if(!hasAny)
            //    return;
            var mask = stream.GetInt();
            CheckStream(stream, 2105483221);
            if ((mask & (1 << 0)) != 0)
            {
                CheckStream(stream, 2105483221);
        ...
        public bool Serialize(ref NetDataWriter stream, bool initial)
        {
            ...
            SafeguardStream(stream, 24112477);
            bool hasAny = false;
            ...
            SafeguardStream(stream, 2105483221);
            if ((deltaMask & (1 << 0)) != 0)
            {
                SafeguardStream(stream, 2105483221);
                hasAny = true;
            ...
            SafeguardStream(stream, -313615825);
            if ((deltaMask & (1 << 1)) != 0)
            {
                SafeguardStream(stream, -313615825);
                hasAny = true;
            ...
            SafeguardStream(stream, -745427717);
            if ((deltaMask & (1 << 2)) != 0)
            {
                SafeguardStream(stream, -745427717);
                hasAny = true;
            ...
            SafeguardStream(stream, -1396303238);
            if ((deltaMask & (1 << 3)) != 0)
            {
                SafeguardStream(stream, -1396303238);
                hasAny = true;
            ...
            SafeguardStream(stream, 507017673);
            if ((deltaMask & (1 << 5)) != 0)
            {
                SafeguardStream(stream, 507017673);
                hasAny = true;
            ...
            SafeguardStream(stream, 1440697065);
            if ((deltaMask & (1 << 8)) != 0)
            {
                SafeguardStream(stream, 1440697065);
                hasAny = true;
    ...
    {
        public override int NetId => 259845187;
