...
namespace NetworkEngine
{
    ...
    public class DeltaListSync<T> : DeltaList<T>, IGhost
    {
        ...
        public bool Serialize(ref NetDataWriter stream, bool initial)
        {
            if (stream == null)
                stream = new NetDataWriter(true, 5);
            SafeguardStream(stream, -273163561);
...
namespace NetworkEngine
{
    ...
    public class SyncEventSync<T> : SyncEvent<T>, IGhost
    {
        public override Int32 SyncId
        {
            get => base.SyncId;
        ...
        public bool Serialize(ref NetDataWriter stream, bool initial)
        {
            if (stream == null)
                stream = new NetDataWriter(true, 5);
            SafeguardStream(stream, -531192393);
            return CustomSerialize(ref stream, initial);
        }
    }
}